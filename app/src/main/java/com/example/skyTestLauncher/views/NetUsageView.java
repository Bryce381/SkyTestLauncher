...
public class NetUsageView extends View {
    ...
    private String[] text ={"较差","中等","良好","较好","极好"};
    ...
    public NetUsageView(Context context) {
        this(context,null);
    }
    ...
    public NetUsageView(final Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        setBackgroundColor(0x274782);
        initAttr(attrs);
        initPaint();
    }
    ...
    private int calculateColor(int value){
        ...
        if(value <= maxNum/2){
            ...
            color = (int) evealuator.evaluate(fraction,0xFFFF8C00,0xFFFF6347); //由橙到红
        }
        return color;
    }
...
//        canvas.restore();
        ...
        paint_2.setStrokeWidth(sweepOutWidth);
        Shader shader = null; // 不再使用SweepGradient
